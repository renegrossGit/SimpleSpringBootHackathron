...
const Zn = async (e, t, n) => window.Vaadin.copilot.comm(e, t, n), Ce = "copilot-", Ks = "24.5.10", Uc = "attention-required", Bc = "https://plugins.jetbrains.com/plugin/23758-vaadin", zc = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode";
function Wc(e) {
...
function Cl() {
  we.push(import("./copilot-log-plugin-ClUyRI-s.js")), we.push(import("./copilot-info-plugin-DFBomwRO.js")), we.push(import("./copilot-features-plugin-fClAUFDR.js")), we.push(import("./copilot-feedback-plugin-CL7IPW8p.js")), we.push(import("./copilot-shortcuts-plugin-BYdlDzfc.js"));
}
function Dl() {
  {
...
let Hr = class extends Pl {
  ...
  async init() {
    if (this.initialized)
      return;
    await window.Vaadin.copilot._machineState.initializer.promise, document.body.style.setProperty("--dev-tools-button-display", "none"), await import("./copilot-global-vars-later-DM34Q7w2.js"), await import("./copilot-init-step2-D3oOfHWw.js"), Vl(), Cl(), this.tabIndex = 0, Dt.hostConnectedCallback(), window.addEventListener("keydown", Ur), E.onSend(this.handleSendEvent), this.removers.push(E.on("close-drawers", this.closeDrawers.bind(this))), this.removers.push(
